...
class Pull_Failed_Test_Cases:
    ...
    def read_data(self, excel_path):
        try:
            ...
            suite_list = self.driver.find_elements(By.XPATH, "//span[contains(text(), "
            ...
            for e in suite_list:
                print(f"Suite list actual is {e.text}")

            type_of_column = "suites"
            Total_number_of_suites = len(suite_list)
            print(Total_number_of_suites)

            underscore_suite = ""

            suite_list1 = self.driver.find_elements(By.XPATH,
                                                    "//span[contains(text(), \"SUITE\")]//parent::div//following-sibling::span[2][@class=\"label fail\"]//following-sibling::span[@class=\"name\"]")
            for b in suite_list1:
                if count == 1:
                    print("Ignore the first webelement")
                else:
                    s2 = b.text.strip()
                    id_type = self.driver.find_element(By.XPATH,
                                                       "//span[text()='" + b.text + "']//parent::div//parent::div//parent::div[@class=\"suite\"]").get_attribute(
                        "id")
                    print(f"id_type is {id_type}")
                    dashCount = id_type.count("-")
                    print(f"Value of dashcount is {dashCount}")
                    if b.text.__contains__("week-regression") or (dashCount == 1):
                        underscore_suite = s2
                        print(f"underscore value is {underscore_suite}")
                        ws.cell(row=count, column=1).value = underscore_suite
                    else:
                        normal_suite = s2
                        print(f"Normal suite value is {normal_suite}")
                        ws.cell(row=count, column=2).value = normal_suite
                        # Test cases
                        myXpath = "(//span[contains(text(), \"SUITE\")]//parent::div//following-sibling::span[3][" \
                                  "@class=\"name\" and text()='" + underscore_suite + \
                                  "']//parent::div//parent::div/following-sibling::div)[3]//span[@class=\"name\" and " \
                        ...
                        toggle_xpath = "((//span[contains(text(), \"SUITE\")]//parent::div//following-sibling::span[3][" \
                                       "@class=\"name\" and text()='" + underscore_suite + \
                                       "']//parent::div//parent::div/following-sibling::div)[3]//span[@class=\"name\" and " \
    ...
    def edit_excel_sheet(self, test_case_list, ws, count, type_of_column, underscore_suite, normal_suite):
        try:
            for c in test_case_list:
                ...
                myXpath2 = "(((//span[contains(text(), \"SUITE\")]//parent::div//following-sibling::span[3][" \
                           "@class=\"name\" and text()='" + underscore_suite + \
                           "']//parent::div//parent::div/following-sibling::div)[3]//span[@class=\"name\" and text(" \
                ...
                testcase_toggle_xpath = "((//span[contains(text(), \"SUITE\")]//parent::div//following-sibling::span[" \
                                        "3][@class=\"name\" and text()='" + underscore_suite + \
                                        "']//parent::div//parent::div/following-sibling::div)[3]//span[" \
                ...
                toggle_state_doc = self.driver.find_element(By.XPATH,
                                                            "((//span[contains(text(), \"SUITE\")]//parent::div//following-sibling::span[3][@class=\"name\" and text()='" + underscore_suite + "']//parent::div//parent::div/following-sibling::div)[3]//span[@class=\"name\" and text()='" + normal_suite + "']//parent::div//parent::div//parent::div//span[text()=" + "\"" + c.text + "\"" + "]//parent::div//parent::div//parent::div//div[@class=\"element-header-toggle\"])[1]//parent::div").get_attribute(
                    "class")
